...
households <- read.csv('./BAN1_Case_Info/A1_Household_Direct_Mail/inHouse_EDA_10k.csv')
...
consumerDF<- read.csv('./BAN1_Case_Info/A1_Household_Direct_Mail/consumerData_training15K_studentVersion.csv')
